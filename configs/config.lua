...
Config.PropCrafting = true -- Set to false to disable prop-based crafting with the Doctor Bag item
...
Config.Stitches = 'NeedleandThread' -- Can change to an equivalent item in your database, remember items are case sensitive
